...
const mockNotifications = [
  ...
  { id: 2, title: "Market Alert", desc: "NVDA reached target price of Γé╣75,000", time: "02:15 AM", type: "alert" },
];
...
export default function Navbar({ activePage, setActivePage }) {
  ...
  // ΓöÇΓöÇΓöÇ GLOBAL KEYBOARD SHORTCUTS (Alt + 1-6) ΓöÇΓöÇΓöÇ
  useEffect(() => {
            ...
            <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} className="relative w-full max-w-md rounded-[32px] bg-[#0d111a] border border-white/[0.1] shadow-2xl p-8 pb-10 overflow-hidden">
                ...
                <form onSubmit={handleLogin} className="space-y-6 relative z-10">
                  ...
                  <div className="relative">
                    ...
                    <input type="password" required id="password" placeholder="ΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇó" className="peer w-full h-16 bg-white/[0.03] border border-white/[0.08] rounded-2xl pl-14 pr-4 pt-6 text-[15px] font-medium text-white placeholder:opacity-0 focus:placeholder:opacity-100 focus:outline-none focus:border-violet-500/50 transition-all" />
